...
export const LABS: readonly LabEntry[] = [
  {
    id: 'translucency',
    title: 'Subsurface translucency on the grass',
    phase: '2.3',
    standard: 'Every shipping grass renderer transmits light through the blade; '
      ...
      + 'term, so at 0.55 the grass is throwing away over half its ambient to buy '
      + 'back a thickness-scaled version of it.',
    scene: 'A flat 60 x 60 foot patch of the real grass under the board\'s own '
