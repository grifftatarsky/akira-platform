...
e.setHardwareScalingLevel(Number("'"$SCALING"'") || 0.5);
...
return { px: e.getRenderWidth() + "x" + e.getRenderHeight(), midMs: mid, wholeBoardMs: far, nearMs: near, fps: Math.round(e.getFps()),
